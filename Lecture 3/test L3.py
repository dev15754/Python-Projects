...
# Ask user 5 favorite foods, sort them alphabetically then add one more food item
...
# Store your name in a tuple correctly using ("Abhy",), print its type
...
#      or movie = input(f"enter fav movie {i+1}")
#     movies.append(movie)
